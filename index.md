...
venue: "Universitat Pompeu Fabra Library, Barcelona, Spain"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
address: "Universitat Pompeu Fabra, Library Barcelona-Room 40.047B"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
country: "ESP"      # lowercase two-letter ISO country code such as "fr" (see https://en.wikipedia.org/wiki/ISO_3166-1#Current_codes) for the institution that hosts the workshop
...
humandate: "Nov 15, 2022  "    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "10:00 am - 14:00 pm CEST"    #2 human-readable times for the workshop e.g., "9:00 am - 4:30 pm CEST (7:00 am - 2:30 pm UTC)"
...
helper: [":Rosa Montañà", ""]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
<p id="who-can-attend">
  <strong>Who can attend?:</strong>
   This workshop is designed for Universitat Pompeu Fabra, Library staff. No programming experience is required
</p>
